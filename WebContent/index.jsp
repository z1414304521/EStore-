...
<!--文件体开始-->
		...
		<tr>
		 ...
		 <c:forEach items="${applicationScope.prods }" var="product" varStatus="status">
		<tr>
			<td class=tablebody2 valign=middle align=center width="">${status.index }</td>
			<td class=tablebody1 valign=middle width="">&nbsp;&nbsp;<a href="productDetail.jsp?productid=${product.id }">${product.name }</a></td>
			<td class=tablebody2 valign=middle align=center width="">${product.price }</td>
			<td class=tablebody1 valign=middle align=center width=""><a href="addProduct.action?productid=${product.id }">
